...
// camera. On a convex hull, which every ship here and the station are, that is not an
...
(function () {
    ...
    // test is only sound on a convex hull — which every ship here and the station are, near enough
